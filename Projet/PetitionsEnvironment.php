...
<body>
  ...
  <div class="site-wrapper">
    <div class="site-wrapper-inner">
      <div class="cover-container">
        ...
        <div class="masthead clearfix">
          ...
          <li role="presentation" style="color: #8080" class="active"><a href='#'>Pétitions Environment</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="row" style="margin-top: 200px; ">
      ...
      //On récupère les 3 dernières pétion entrés dans la table catégorie environement
    $pet=$bdd->query('SELECT Titre, Texte, id FROM petitions WHERE categorie=\'environment\' ORDER BY ID DESC LIMIT 0, 3');
