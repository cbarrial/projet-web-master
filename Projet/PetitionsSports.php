  ...
  <div class="site-wrapper">
    <div class="site-wrapper-inner">
      ...
      <div class="row" style="margin-top: 200px; ">
        ...
        //On récupère les 3 dernières pétion entrés dans la table catégorie sport
      $pet=$bdd->query('SELECT Titre, Texte, id FROM petitions WHERE categorie=\'sport\' ORDER BY ID DESC LIMIT 0, 3');
