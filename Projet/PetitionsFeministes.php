...
<body>
  ...
  <div class="site-wrapper">
    ...
    <div class="row" style="margin-top: 200px; ">
      ...
      //On récupère les 3 dernières pétion entrés dans la table catégorie féministe
    $pet=$bdd->query('SELECT Titre, Texte, id FROM petitions WHERE categorie=\'feministe\' ORDER BY ID DESC LIMIT 0, 3');
